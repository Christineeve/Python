...
e4={
    "guid":"07262021_004",
    "ingestdate":"07262021",
    "content": "This is the content for item four",
    "createdate": "07262021",
    "creator": 'christine.e.lee',
    "id": '04',
    "recipient": 'whitneym',
...
res = es.index(index='testindex',doc_type='_doc',id=1,body=e1)
print('created1')
res = es.index(index='testindex',doc_type='_doc',id=2,body=e2)
print('created2')
res = es.index(index='testindex',doc_type='_doc',id=3,body=e3)
print('created3')
res = es.index(index='testindex',doc_type='_doc',id=4,body=e4)
print('created4')
